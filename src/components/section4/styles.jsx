let styles = {
  bg: "bg-custom-black-100 h-max pt-9 lg:hidden",
  ...
  textP: "text-white font-inter font-normal pr-24 text-sm lg:pl-20 ",
  ...
  expH6: "font-roboto font-bold text-xs text-white pl-7"
};
