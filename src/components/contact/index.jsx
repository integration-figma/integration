...
import Adress from "../../assets/img/icone/adress.svg";
import Mail from "../../assets/img/icone/mail.svg";
import Tel from "../../assets/img/icone/tel.svg";
...
<section class="text-gray-600 body-font relative bg-custom-black-500">
  <div class="container px-5 py-32 mx-auto flex sm:flex-nowrap flex-wrap ">
    <div class="lg:w-1/3 md:w-1/2  flex flex-col md:ml-auto w-full  bg-custom-black-500">
      <div class="relative mb-4 bg-custom-black-500">
      ...
      <button class="text-white bg-custom-red border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Envoyer</button>
    </div>
  </div>
</section>
  </>
